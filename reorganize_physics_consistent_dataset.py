#!/usr/bin/env python3
"""
Script to reorganize dataset_2_reg_physics_consistent into proper input/output structure.
Only copies samples that have complete data including topology files from dataset_2_reg.
"""
...
def find_complete_samples():
    ...
    # Define data paths
    dataset_2_reg_dir = "/workspace/topodiff/data/dataset_2_reg/training_data"
    ...
    topo_indices = find_sample_indices(dataset_2_reg_dir, "gt_topo_*.png")
...
def copy_files(complete_indices, training_dir, displacement_dir):
    ...
    for i, idx in enumerate(complete_indices):
        try:
            # Copy topology file from dataset_2_reg
            topo_src = os.path.join(dataset_2_reg_dir, f"gt_topo_{idx}.png")
...
def main():
    ...
    print("=== Physics-Consistent Dataset Reorganization ===\n")
    ...
    base_dir = "/workspace/topodiff/data/dataset_2_reg_physics_consistent_structured"
